...
const About = () => {
  return (
    <div className="bg-black text-white">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-rose-900 to-rose-700">
      ...
      <div className="bg-gray-900 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-rose-500 mb-12">
            Why Choose Voxbuy?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg shadow-md">
              <div className="w-12 h-12 bg-rose-900 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-400">Carefully curated selection of high-quality fashion items and accessories from trusted brands and manufacturers.</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg shadow-md">
              <div className="w-12 h-12 bg-rose-900 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-rose-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-gray-400">Best value for your money with competitive prices and regular deals and discounts on our products.</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg shadow-md">
              <div className="w-12 h-12 bg-rose-900 rounded-full flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-rose-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Easy Shopping</h3>
              <p className="text-gray-400">User-friendly interface with advanced filters and search options to help you find exactly what you're looking for.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Values Section */}
      <div className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center text-rose-500 mb-12">Our Values</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-white mb-4">Customer First</h3>
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-rose-900 to-rose-700">
        <div className="container mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <Link 
              href="/browseproduct"
              className="inline-block bg-black text-rose-500 px-8 py-3 rounded-lg font-semibold hover:bg-gray-900 hover:text-rose-400 transition-colors border border-rose-500"
            >
              Browse Products
            </Link>
          </div>
